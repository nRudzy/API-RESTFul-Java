...
public class Billet implements Serializable {
	...
	Groupe groupe = Groupe.getGroupe("all");
	if(groupe != null)
	    this.groupe = groupe;
	else
	    this.groupe = new Groupe("all", "description", "");
    }

    public Billet(String titre, String contenu, String auteur, String strGroupe) {
        this.titre = titre;
        this.contenu = contenu;
        this.auteur = auteur;
        this.commentaires = new ArrayList<>();
        this.groupe = Groupe.getGroupe(strGroupe);
    }
